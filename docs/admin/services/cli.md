...
🗒️ The CLI does not install ThingsBoard and PostgreSQL services. See
the commands in [manual install](terminal-install.md) page for installing
these two services.
...
Run the following commands from a virtual environment.
